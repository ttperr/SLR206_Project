...
plt.xlabel('Threads')
plt.ylabel('Throughput (ops/s)')
plt.title('Performance of the Coarse Grained Algorithm with list size = 100')
plt.grid(True, which="both")
...
plt.xlabel('Threads')
plt.ylabel('Throughput (ops/s)')
plt.title('Performance of the Hand Over Hand Algorithm with list size = 100')
plt.grid(True, which="both")
plt.legend(['u = 0%', 'u = 10%', 'u = 100%'])
...
plt.xlabel('Threads')
plt.ylabel('Throughput (ops/s)')
plt.title('Performance of the Lazy Algorithm with list size = 100')
plt.grid(True, which="both")
plt.legend(['u = 0%', 'u = 10%', 'u = 100%'])
